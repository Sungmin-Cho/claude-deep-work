...
function failShadow(mrOut, request, started, extra) {
  ...
  return {
    ...
    shadow: {
      ...
      identity: { route_schema_version: null, router_plugin_version: null,
                  policy_sha256: null, decision_fingerprint: null,
                  request_sha256: null },
    ...
    return {
      ...
      shadow: {
        ...
        identity: {
          ...
          decision_fingerprint: parsed ? parsed.decision_fingerprint ?? null : null,
          request_sha256: parsed ? parsed.request_sha256 ?? null : null,
        },
