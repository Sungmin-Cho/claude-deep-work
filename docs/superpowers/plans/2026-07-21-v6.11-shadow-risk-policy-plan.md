...
**Interfaces:**
- Consumes: Task 3 CLI slice 계약, plan.md의 slice 목록(스킬이 이미 보유)
...
4. 실패: `risk_profile_json.errors`에 `{stage: "slice", message: "SLICE-NNN: <error>", at}` append — `slice_risk_shadow_json`은 성공한 slice만 보관한다 (스펙 §5.1)
