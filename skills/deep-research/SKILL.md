...
2. 점수가 낮은 차원(< 5.0)을 research context에 포함:
   ...
   ```
3. topology 감지 시 harnessability 낮은 차원을 research context에 보강 제안으로 포함
...
- `project_type: zero-base` → Read("skills/shared/references/zero-base-guide.md") 후 Zero-Base Research 수행
