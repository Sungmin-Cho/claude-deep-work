...
describe('release metadata', () => {
  it('active release metadata is bumped to 6.12.0 with 6.9.0 feature docs intact', () => {
    // 6.12.0 is a feature release (adaptive routing and unified review): the
    ...
    const version = '6.12.0';        // current release — manifests
    ...
    // Current release (6.12.0) — adaptive routing and unified review.
    ...
    assert.ok(changelogCurrent.includes('runtime/risk-runtime.js'),
      'CHANGELOG.md 6.12.0 section must cite the risk runtime');
    assert.ok(changelogKoCurrent.includes('runtime/risk-runtime.js'),
      'CHANGELOG.ko.md 6.12.0 section must cite the risk runtime');
